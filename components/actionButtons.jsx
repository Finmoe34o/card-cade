...
export default function page({serverObject, playerNum}) {
    ...
    const playerArr = serverObject.players !== undefined ? serverObject.players: console.error("no player arr")
    ...
    <button onClick={leaveFunct} className="w-[10vw] h-[7.5vh] relative left-[1vw] top-[1vh] bg-[#616161] bg-opacity-90 rounded-2xl">Leave</button>
      ...
      <div className="w-[100vw] h-[100vh]">
        <div className=" absolute left-[15vw] top-[65vh]">
          <div className={`${Number(playerNum) < 5 ? playerArr.includes(playerNum + 1) ? "block" : "hidden" : playerArr.includes(playerNum - 4) ? "block" : "hidden"} ${Number(playerNum) < 5 ? turn === Number(playerNum) + 1 ? "border-[6px] animate-pulse border-green-400" : "border-[1px]" : turn  === Number(playerNum) - 4 ? "border-[6px] animate-pulse border-green-500" : "border-[1px]"} bg-gray-600 flex flex-col w-[120px] h-[120px] rounded-full border-[1px] border-white`}></div>
        ...
        <div className="absolute left-[15vw] top-[9vh]">
          <div className={`${Number(playerNum) < 4 ? playerArr.includes(playerNum + 2) ? "block" : "hidden" : playerArr.includes(playerNum - 3) ? "block" : "hidden"} ${Number(playerNum) < 4 ? turn === Number(playerNum) + 2 ? "border-[6px] animate-pulse border-green-400" : "border-[1px]" : turn  === Number(playerNum) - 3 ? "border-[6px] animate-pulse border-green-500" : "border-[1px]"} bg-gray-600 flex flex-col w-[120px] h-[120px] rounded-full border-[1px] border-white`}></div>
        ...
        <div className="absolute right-[15vw] top-[9vh]">
          <div className={`${Number(playerNum) < 3 ? playerArr.includes(playerNum + 3) ? "block" : "hidden" : playerArr.includes(playerNum - 2) ? "block" : "hidden"} ${Number(playerNum) < 3 ? turn === Number(playerNum) + 3 ? "border-[6px] animate-pulse border-green-400" : "border-[1px]" : turn  === Number(playerNum) - 2 ? "border-[6px] animate-pulse border-green-500" : "border-[1px]"} bg-gray-600 flex flex-col w-[120px] h-[120px] rounded-full border-[1px] border-white`}></div>
        ...
        <div className="absolute right-[15vw] top-[65vh]">
          <div className={`${Number(playerNum) < 2 ? playerArr.includes(playerNum + 4) ? "block" : "hidden" : playerArr.includes(playerNum - 1) ? "block" : "hidden"} ${Number(playerNum) < 2 ? turn === Number(playerNum) + 4 ? "border-[6px] animate-pulse border-green-400" : "border-[1px]" : turn  === Number(playerNum) - 1 ? "border-[6px] animate-pulse border-green-500" : "border-[1px]"} bg-gray-600 flex flex-col w-[120px] h-[120px] rounded-full border-[1px] border-white`}></div>
