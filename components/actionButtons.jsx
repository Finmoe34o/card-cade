...
export default function page({minBet, turn, pot, stackSize, serverNum, playerNum}) {
    ...
    console.log(turn === Number(playerNum) ? "true" : "fasle")
    return <div className="flex absolute justify-between w-[50vw] h-[20vh]">
        <button onClick={turn === pNum ? foldFunct : null} className="w-[15vw] h-[10vh] bg-gray-700 rounded-2xl">Fold{Math.floor((216 - mouseY) / 1.88)}</button>
